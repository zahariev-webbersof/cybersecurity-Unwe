...
- **Изискване**: Напишете подробен казус (500 думи), който включва контекст, изпълнение и последици от измамата.
...
- **Изискване**: Подайте обобщения доклад (2000 думи минимум), който включва всички анализи, казуси и стратегии за предотвратяване на онлайн измами, форматиран според академичните стандарти.

#### Указания за предаване
- **✅ Краен срок за предаване [16.03.2025] ✅**
